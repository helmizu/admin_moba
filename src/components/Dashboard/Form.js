...
import { loadData, insertPelatih, insertManajer, insertMedis, insertGuru, insertPemain, updatePelatih, updateManajer, updateMedis, updateGuru, updatePemain } from '../../actions/dataAction';
...
export class Form extends Component {
    static propTypes = {
        ...
        insertManajer : PropTypes.func.isRequired,
        insertMedis : PropTypes.func.isRequired,
        insertGuru : PropTypes.func.isRequired,
        insertPemain : PropTypes.func.isRequired,
        updatePelatih : PropTypes.func.isRequired,
        updateManajer : PropTypes.func.isRequired,
        updateMedis : PropTypes.func.isRequired,
        updateGuru : PropTypes.func.isRequired,
    ...
    onSubmit(e) {
        ...
        formData.append('sekolah', this.props.sekolah)
        if(!this.props.update) {
            ...
            if (this.props.namaForm === "Manajer"){
                formData.append('nama', this.state.nama)
                formData.append('foto', this.state.foto, this.state.foto.name)
                formData.append('ktp', this.state.ktp, this.state.ktp.name)
                
                return this.props.insertManajer(formData)
            }
            if (this.props.namaForm === "Medis"){
                formData.append('nama', this.state.nama)
                formData.append('foto', this.state.foto, this.state.foto.name)
                formData.append('ktp', this.state.ktp, this.state.ktp.name)
                
                return this.props.insertMedis(formData)
            }
            if (this.props.namaForm === "Guru"){
                formData.append('nama', this.state.nama)
                formData.append('foto', this.state.foto, this.state.foto.name)
                formData.append('ktp', this.state.ktp, this.state.ktp.name)
                
                return this.props.insertGuru(formData)
            }
            ...
            if (this.props.namaForm === "Pelatih"){
                ...
                if (this.props.namaForm === "Manajer"){
                    return this.props.updateManajer(this.props.data.update._id, formData)
                }
                if (this.props.namaForm === "Medis"){
                    return this.props.updateMedis(this.props.data.update._id, formData)
                }
                if (this.props.namaForm === "Guru"){
                    return this.props.updateGuru(this.props.data.update._id, formData)
                }
                if (this.props.namaForm === "Pemain"){
    ...
    componentWillReceiveProps = (nextProps) => {
        ...
        if (nextProps.data.success !== this.props.data.success) {
            ...
            this.props.loadData(this.props.sekolah)
        }
